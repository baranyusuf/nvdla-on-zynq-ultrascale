...
HD_PWD='C:/Xilinx/nvdla_zynq_implementation/nvdla_zynq_implementation.runs/nvdla_bd_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nvdla_bd_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nvdla_bd_zynq_ultra_ps_e_0_0.tcl
