...
HD_PWD='C:/Xilinx/nvdla_zynq_implementation/nvdla_zynq_implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nvdla_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nvdla_bd_wrapper.tcl -notrace
