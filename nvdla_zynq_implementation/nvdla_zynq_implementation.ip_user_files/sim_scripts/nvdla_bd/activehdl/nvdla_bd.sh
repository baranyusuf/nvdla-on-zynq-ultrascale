...
#                script (type 'nvdla_bd.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Xilinx/nvdla_zynq_implementation/nvdla_zynq_implementation.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
